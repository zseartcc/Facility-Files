...
Brainstorm:
    ...
    1. Ask user to select profiles to update
        a. GUI: checkboxes/select from list
    2. Ask user to choose what they want to be done
        a. GUI: checkboxes
    3. Do tasks (separate func for each)
        a. For each profile, run each task
        b. Progress message (or bar?)

Tasks:
    - Update aliases
    - Update positions
    - Build/update video maps
    - Assemble profile
...
class App(tk.Frame):
    def __init__(self, parent):
        ...
        # # "Do All" button
        # doAllBtn = tk.Button(
        #     tasksFrame, text="Do All Tasks", command=None, bg="#4287f5",
        #     activebackground="#3368bd", pady=5, padx=5
        # )
        # doAllBtn.pack(side="right", padx=6, pady=10)
